...
<html lang="en">
  ...
  <body class="m-auto ">
    <div class="m-auto overflow-x-hidden max-w-vtex ">
      ...
      <section class="h-[22rem] mt-64 hidden md:flex bg-black-default items-center justify-center">
      ...
      <section class="hidden  lg:grid mx-5 mt-10 md:mt-[12rem] lg:grid-cols-2 md:mx-20">
