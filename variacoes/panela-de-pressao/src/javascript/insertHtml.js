...
<html lang="en">
  ...
  <main class="m-auto max-w-vtex">
    <div class="overflow-x-hidden">
      ...
      <section class="flex flex-col items-center mt-14 md:mt-36">
        ...
        <div
          ...
          <div
            ...
            <h1
              class="mt-10 text-2xl font-bold leading-snug text-center text-black uppercase md:text-2xl font-poppins">
      ...
      <section
      class="flex flex-col gap-2 pb-20 mt-20 text-white 60 bg-black-default md:rounded-3xl">
      <div class="relative grid grid-cols-2 gap-8">
        <img
        class="absolute object-fill w-[5rem] md:translate-x-12 animation -top-16 left-0 md:-top-28 md:-left-[6rem] md:w-[15rem] animate-float"
        ...
        <div class="relative z-10 flex flex-col items-center mt-20 ml-8 md:mt-40 md:ml-20">
          ...
          <p class="z-10 text-2xl font-light md:text-3xl font-poppins">
            DE CAPACIDADE
          </p>
          <p
        ...
        <div class="relative flex items-start justify-start w-[120%]">
          <img
            class="absolute z-10 hidden md:block animation object-fill w-[2rem] md:w-[8rem] md:-left-36 left-8 animate-float"
            src="./images/effect_imgs/effect_img_2.png"
            alt="Imagem de efeito" />
          <img
            class="absolute z-10 animation object-fill w-[2rem] hidden  md:block -top-[6rem] md:top-10 md:w-[8rem] md:right-20 animate-float"
            src="./images/effect_imgs/effect_img_4.png"
            alt="Imagem de efeito" />

          <img
            class="absolute z-10 animation object-fill right-[5rem] md:right-14 top-[10rem] lg:top-[5rem] w-[5rem] md:w-[15rem] animate-float"
      ...
      <div class="flex flex-wrap items-center w-full gap-10 px-2 mt-12 md:mt-0 sm:px-10 md:mx-0 md:gap-2 md:flex-nowrap justify-evenly">
      ...
      <section class="grid mx-5 mt-20 lg:mt-0 md:ml-20 md:grid-cols-2">
        <div class="flex flex-col md:gap-10 md:justify-center md:ml-0">
          <div class="flex flex-col h-auto gap-3 mt-10 md:mt-0">
            ...
            <h1 class="text-2xl font-black md:text-4xl text-black-default font-poppins">
              10 FUNÇÕES <br />
              PRÉ-PROGRAMADAS
            </h1>
            <p
      ...
      <section class="grid mx-5 mt-20 lg:grid-cols-2 md:mx-20">
        <div class="flex flex-col justify-center w-[95%] gap-5 text-black-default">
          ...
          <h1 class="mt-10 text-2xl font-bold font-poppins">FUNÇÕES PARA FACILITAR SUA ROTINA</h1>
          <p class="w-[90%]">
      ...
      <section class="flex flex-col items-center -mt-16 lg:-mt-44 min-h-[40vh] pb-10 bg-black-default rounded-3xl">
      ...
      <section class="flex flex-col text-white bg-black-default md:grid md:grid-cols-2 md:h-full h-[35rem] mt-52 rounded-3xl">
        ...
        <div class="flex flex-col justify-center order-1 gap-5 mx-5 mt-10 md:order-2 md:mt-0 md:mx-0">
          <h1 class="font-bold md:text-4xl font-poppins">
      ...
      <section class="grid items-center justify-center mx-5 mt-20 lg:grid-cols-2">
        <div class="lg:h-[45rem] h-[50rem] flex flex-col items-center justify-center rounded-t-full w-full sm:w-[80%] m-auto rounded-b-full bg-red-default">
          ...
          <div class="translate-y-4 h-[110%]">
            <img src="./images/produto-de-frente.png" class="px-10 " alt="">
          </div>
        </div>
      ...
      <section class="grid m-auto lg:grid-cols-2">
        <div
          ...
          <div
            ...
            <h1 class="w-full mt-5 font-bold uppercase md:text-center md:text-2xl text-black-default font-poppins">
