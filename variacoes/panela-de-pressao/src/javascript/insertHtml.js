...
<html lang="en">
  ...
  <main class="m-auto max-w-vtex">
    <div class="overflow-x-hidden">
        ...
        <div
          ...
          <div
            ...
            <h1
              ...
              10 DISPOSITIVOS DE <br> SEGURANÇA
            </h1>
            <p
      ...
      <section class="grid grid-rows-2 mx-8 mt-40 md:grid-rows-1 gap-x-10 md:grid-cols-2">
        <div>
          <img src="./images/produto-com-alimento-dentro.png" alt="">
        </div>
        <div class="flex flex-col justify-center -mt-10 md:mt-0">
          <h1 class="mt-4 text-base font-bold leading-snug text-black uppercase md:text-4xl font-poppins">
      ...
      <section
      class="flex flex-col gap-2 pb-20 mt-20 text-white md:mt-60 bg-black-default md:rounded-3xl">
      <div class="grid grid-cols-2 gap-8">
        <div class="relative z-10 flex flex-col items-center mt-20 ml-8 md:mt-40 md:ml-20">
          <img
          ...
          <p
            class="hidden sm:block font-inter mt-5 text-center z-10 font-light tracking-tighter text-sm sm:text-base  lg:w-[70%]">
        ...
        <div class="relative flex items-start justify-start w-[120%]">
          <img
            class="absolute z-10 animation object-fill w-[2rem] md:w-[8rem] md:-left-36 left-8 animate-float"
            src="./images/effect_imgs/effect_img_2.png"
            alt="Imagem de efeito" />
          <img
            class="absolute z-10 animation object-fill w-[2rem]  md:block -top-[6rem] md:top-10 md:w-[8rem] md:right-20 animate-float"
            src="./images/effect_imgs/effect_img_4.png"
            alt="Imagem de efeito" />

          <img
            class="absolute z-10 animation object-fill right-[5rem] md:right-14 top-[10rem] w-[5rem] md:w-[15rem] animate-float"
            src="./images/effect_imgs/effect_img_3.png"
            alt="Imagem de efeito" />
          <img
            src="./images/produto_com_alimento.png"
            class="mr-0 mx-12 -translate-y-[2rem] w-[14rem] -translate-x-[5rem] sm:-translate-y-[2rem] md:-translate-y-[5rem] md:-translate-x-[8rem] md:mr-5 md:w-full"
            alt="" />
        </div>
      </div>
      ...
      <div class="flex flex-wrap items-center w-full gap-10 px-2 mt-12 sm:px-10 md:mx-0 md:gap-2 md:flex-nowrap justify-evenly">
      ...
      <section class="grid mx-5 mt-20 lg:grid-cols-2 md:mx-20">
        <div class="flex flex-col justify-center w-[90%] gap-5 text-black-default">
          ...
          <h1 class="text-2xl font-bold uppercase lg:hidden font-poppins">Mais segurança para cozinhar </h1>
          <p class="w-[90%]">
        ...
        <div class="relative flex flex-col lg:w-[800px] lg:h-[750px]">
          ...
          <div class="hidden lg:block">
            ...
            <span id="span1" onmouseover="productInspect(event)" onmouseout="hideInspect(event)" class=" absolute rounded-full px-4 py-4  bottom-[21rem] left-[22%]">
              <div class="w-[25rem] absolute rounded-lg p-4 hidden -bottom-10 right-[2.5rem] bg-white shadow-2xl py-5 px-5 text-black-default" id="infoBox">
                <h1 class="text-lg font-bold font-poppins">NÍVEL DE COZIMENTO</h1>
            ...
            <span id="span2" onmouseover="productInspect(event)" onmouseout="hideInspect(event)" class=" absolute rounded-full px-4 py-4  bottom-[17.5rem] left-[12.4rem]">
              <div class="w-[25rem] absolute rounded-lg p-4 hidden -bottom-10 right-[2.5rem] bg-white shadow-2xl py-5 px-5 text-black-default" id="infoBox">
                <h1 class="text-lg font-bold font-poppins">PROGRAMAR PREPARO</h1>
            ...
            <span id="span3" onmouseover="productInspect(event)" onmouseout="hideInspect(event)" class=" absolute rounded-full px-4 py-4  bottom-[17.5rem] left-[15.5rem]">
              <div class="w-[25rem] absolute rounded-lg p-4 hidden -bottom-10 right-[2.5rem] bg-white shadow-2xl py-5 px-5 text-black-default" id="infoBox">
                <h1 class="text-lg font-bold font-poppins">SELETOR DE TEMPO</h1>
            ...
            <span id="span4" onmouseover="productInspect(event)" onmouseout="hideInspect(event)" class=" absolute rounded-full px-4 py-4  bottom-[22.5rem] left-[16.5rem]">
              <div class="w-[25rem] absolute rounded-lg p-4 hidden -bottom-10 right-[2.5rem] bg-white shadow-2xl py-5 px-5 text-black-default" id="infoBox">
                <h1 class="text-lg font-bold font-poppins">MANTER AQUECIDO / CANCELAR</h1>
      ...
      <section class="mt-28 lg:mt-10">
        <img class="hidden cursor-text md:block" src="./images/dispositivos-de-seguranca-desktop.png" alt="">
        <img class="cursor-text md:hidden" src="./images/dispositivos-de-seguranca-mobile.png" alt="">
      </section>

      <section class="mt-32">
        <img class="hidden cursor-text md:block" src="./images/sessao-antiaderente-gray-stone-desktop.png" alt="">
        <img class="cursor-text md:hidden" src="./images/sessao-antiaderente-gray-stone-mobile.png" alt="">
      </section>

      <section class="grid mt-20 ml-5 lg:mt-32 md:mx-0 lg:grid-cols-2">
      ...
      <section class="grid m-auto mx-5 mt-40 lg:grid-cols-2">
        <div class="flex flex-col items-center justify-center">
          <img class="hidden md:block" src="./images/produto-de-frente-desktop.png" alt="">
          <img class="md:hidden" src="./images/produto-de-frente-mobile.png" alt="">
        </div>

        <div
          class="flex flex-col gap-[2.5rem] md:items-start  ml-5 md:mt-14 md:ml-20 lg:py-14 cards-section">
          <div class="">
            <img class="w-10 md:w-14" src="./images/icons/finger_touching_black.png" alt="" />
          ...
          <div>
            <img
              class="w-10 md:w-14"
              src="./images/icons/arch_black.png"
          ...
          <div>
            <img class="w-10 md:w-14" src="./images/icons/lock_black.png" alt="" />
          ...
          <div>
            <img class="w-10 md:w-14" src="./images/icons/temperature_black.png" alt="" />
      ...
      <section class="grid m-auto lg:grid-cols-2">
        <div
          ...
          <div
            ...
            <img class="w-10 md:w-14 md:hidden" src="./images/icons/light_red.png" alt="Icone lâmpada" />
          ...
          <div
            class="flex flex-col items-center justify-center text-center lg:items-start card">
            <h1
              class=" mt-5 font-bold uppercase md:text-start md:text-2xl md:w-[25rem] w-[20rem] text-black-default font-poppins">
